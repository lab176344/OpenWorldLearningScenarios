...
class TimeSformer(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.head2 = nn.Sequential(
            nn.LayerNorm(dim),
            nn.Linear(dim, num_Unlabelledclasses)
        )
    ...
    def forward(self, video, mask = None):
        ...
        cls_token = x[:, 0]
        return self.head1(cls_token),self.head2(cls_token),cls_token
